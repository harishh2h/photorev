 ...
 *
 * @param {{ collaboratingLabel: string; onAddPhotos: () => void; isUploading?: boolean }} props
 * @returns {import('react').JSX.Element}
 */
export default function ProjectGridOverlays({ collaboratingLabel, onAddPhotos, isUploading = false }) {
  return (
